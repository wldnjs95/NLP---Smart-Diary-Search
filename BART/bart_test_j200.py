# -*- coding: utf-8 -*-
"""bart_test_j200.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1uwx7eyrwgvRD7Ugj4aBl0AIdSy4Yd4PN
"""
...
test_train_entries = [
  'As soon as I heard that Jimmy O. Yang was doing a nationwide tour in March, I booked my ticket right away. There are still a few months left, but I’m so excited that I watch his shorts every day—it already seems like it’s going to be fun. But I’m worried there might not be any parking spots nearby. Not having a place to park would be such a hassle. Oh well, let’s just think positive!',
  'It’s already been two years since I started learning pottery from my teacher. I’ve always wanted to learn techniques for mixing different colors in pottery, and last week, I finally learned the last one. My teacher said there was nothing more to teach me. Recently, I created an Instagram page to share my pottery work. If anyone is interested, I’m open to selling my pieces, though I’m unsure about the demand.',
  'I can’t understand why Sarah acted that way. I clearly asked her to keep everything I said about my research topic strictly confidential. I don’t know if she simply forgot or chose to ignore my request, but I’m completely done with her. This is where I draw the line.'
]
...
print("Final test results saved to 'final_test_results_jcleaned.csv'.")